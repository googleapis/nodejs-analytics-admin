...
function main(name) {
  // [START admin_v1alpha_generated_AnalyticsAdminService_GetIosAppDataStream_async]
  /**
  ...
  async function getIosAppDataStream() {
    // Construct request
    const request = {
      name,
    };
  ...
  getIosAppDataStream();
  // [END admin_v1alpha_generated_AnalyticsAdminService_GetIosAppDataStream_async]
}
