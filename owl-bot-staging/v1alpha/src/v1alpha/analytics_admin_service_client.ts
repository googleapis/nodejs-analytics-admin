  ...
  constructor(opts?: ClientOptions) {
    ...
    this.descriptors.page = {
      ...
      listDisplayVideo360AdvertiserLinks:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'displayVideo360AdvertiserLinks'),
      listDisplayVideo360AdvertiserLinkProposals:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'displayVideo360AdvertiserLinkProposals'),
 ...
 */
  updateDisplayVideo360AdvertiserLink(
    ...
    options.otherArgs.headers[
      ...
      'display_video_360_advertiser_link.name': request.displayVideo360AdvertiserLink!.name || '',
    });
    this.initialize();
 ...
 */
   ...
   * @returns {string} Resource name string.
   */
  measurementProtocolSecretPath(property:string,webDataStream:string,measurementProtocolSecret:string) {
  ...
  matchWebDataStreamFromMeasurementProtocolSecretName(measurementProtocolSecretName: string) {
    return this.pathTemplates.measurementProtocolSecretPathTemplate.match(measurementProtocolSecretName).web_data_stream;
  }
